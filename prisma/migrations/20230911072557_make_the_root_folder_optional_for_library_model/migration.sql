-- DropForeignKey
ALTER TABLE "Library" DROP CONSTRAINT "Library_root_folder_id_fkey";

-- AlterTable
ALTER TABLE "Administrator" ALTER COLUMN "admin_id" SET DEFAULT (concat('admin_', gen_random_uuid()))::TEXT;

-- AlterTable
ALTER TABLE "Library" ALTER COLUMN "root_folder_id" DROP NOT NULL;
...
-- AddForeignKey
ALTER TABLE "Library" ADD CONSTRAINT "Library_root_folder_id_fkey" FOREIGN KEY ("root_folder_id") REFERENCES "LibraryFolder"("id") ON DELETE SET NULL ON UPDATE CASCADE;
