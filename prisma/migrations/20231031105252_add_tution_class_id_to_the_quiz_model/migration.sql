...
-- AlterTable
ALTER TABLE "Quiz" ADD COLUMN     "tution_class_id" TEXT,
ALTER COLUMN "quiz_id" SET DEFAULT (concat('quiz_', gen_random_uuid()))::TEXT;
...
-- AddForeignKey
ALTER TABLE "Quiz" ADD CONSTRAINT "Quiz_tution_class_id_fkey" FOREIGN KEY ("tution_class_id") REFERENCES "TutionClass"("class_id") ON DELETE SET NULL ON UPDATE CASCADE;
