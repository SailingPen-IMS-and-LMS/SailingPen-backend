/*
  ...
  - Added the required column `video_thumbnail_url` to the `WeeklySession` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "WeeklySession" ADD COLUMN     "video_thumbnail_url" TEXT NOT NULL,
