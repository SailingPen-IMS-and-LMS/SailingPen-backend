...
export class TutionClassesService {
        ...
        const enrollments = await this.prisma.enrollment.findMany({
            ...
            , include: {
                tuition_class: {
                    include: {
                        tutor: {
                            include: { user: { select: { f_name: true, l_name: true, avatar: true } } }
                        }
                    },
                }
            }
    ...
    async createTutionClass({ class_name, class_description,admission_fee, monthly_fee, subject_id, tutor_id }: CreateTutionClassDto) {
        try {
